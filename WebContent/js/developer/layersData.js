				...
				html += "<div class='card full-accordion layers-toggle'>" +
						...
						for(let a = 0 ; a < len ; a++){
							...
							html += "<label class='checkbox-inline' data-placement='right' title='"+name+"'>" +
							  "<input id="+combination+" data-layerid="+id+" data-departmentid="+parent_id+" type='checkbox' data-gisid="+gis_id+" data-wmsurl="+ wms_url +" class='list-item' value='"+name+"' "+checked+">"+name+" " +
							"</label>" +
