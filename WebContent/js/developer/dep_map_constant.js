...
global.ACCIDENT_URL = global.INDORE_LAYERS_SYMBOLOGY + "/" + "150";
global.BUILDING_FOOTPRINT_2020_URL = global.prefix_layer_url + "Highrise_Building_density_14122021/MapServer/1";
global.VEHILCE_THEFT_URL = global.INDORE_LAYERS_SYMBOLOGY + "/"  + "154";

/**
 * Satellite Image 2015
 */
global.TILED_IMAGE_2015 = global.prefix_layer_url + "ISCDL_Satellite_Image_2015/MapServer";//
...
global.ISCDL_RIVER_DEM_TIFF = global.prefix_layer_url + "Image/river_dem_image/MapServer";

global.ISCDL_SRTM_IMAGE_LAYER = global.prefix_layer_url + "Image/SRTM/MapServer";

//Temporary remove Administrative main layer id for feature Info tool
global.DEPARTMENT_ADMINISTRATIVE_BOUNDARY = 82;

//Temporary remove Environment main layer id for feature Info tool
global.DEPARTMENT_ENVIRONMENT_BOUNDARY = 63;

//Temporary remove City Amenities main layer id for feature Info tool
global.DEPARTMENT_CITY_AMENITIES_BOUNDARY = 0;

//Temporary remove Town and country planning main layer id for feature Info tool
global.DEPARTMENT_TOWN_COUNTRY_BOUNDARY = 160;
...
global.BUILDING_FEATURE_SERVER_LAYER = global.ISCDL_FEATURE_SERVER_URL + "89";



//heritage building

global.HERITAGE_GANDHI_HALL = global.prefix_layer_url +"Hosted/Gandhi_hall/SceneServer/layers/0";//
global.HERITAGE_HOLKAR_STADIUM = global.prefix_layer_url +"Hosted/Holkar_Stadium/SceneServer/layers/0";//
global.HERITAGE_WHITE_CHURCHE = global.prefix_layer_url +"Hosted/whitechurche_03_sept/SceneServer/layers/0";//
global.HERITAGE_NAXTRA_WEDDING_HALL = global.prefix_layer_url +"Hosted/Naxtra_Wedding_Hall/SceneServer/layers/0";//
global.HERITAGE_NEHRU_STADIUM = global.prefix_layer_url +"Hosted/Nehru_Stadium/SceneServer/layers/0";//
global.HERITAGE_LALBHAG = global.prefix_layer_url +"Hosted/Lalbhag_22_oct/SceneServer/layers/0";//
global.HERITAGE_RAJAWADA = global.prefix_layer_url +"Hosted/Rajawada__23_dec/SceneServer/layers/0";//
global.HERITAGE_KHAJRANA_TEMPLE = global.prefix_layer_url +"Hosted/Khajrana_Temple_1/SceneServer/layers/0";//
global.HERITAGE_COLLECTOR_OFFICE = global.prefix_layer_url +"Hosted/Collector_Office_1/SceneServer/layers/0";//
