...
<title>Public Distribution System Centers</title>
		...
		<div class="admin-content">
			...
			<ul class="nav nav-tabs full-linetab-admin justify-content-center">
				<li class="nav-item"><a class="nav-link tab-data active"
					data_translate="_primary" data-toggle="tab" href="#pdsc_Dept">Public Distribution System Centers</a></li>
			</ul>

			<!-- Tab panes -->
			<div class="tab-content">
				<div class="tab-pane container-fluid active" id="pdsc_Dept">

					<div class="text-right">
						<button data-toggle="modal" data-target="#pdsc_modal"
							data_translate="_add_data" class="btn-add btn-indore-table">Add Data</button>
					</div>

					<h6 class="table-title-grid"
						data_translate="_list_of_primary_school">List Public Distribution System Centers</h6>
					<table id="pdsc_table" class="display tbl_dep" class="tbl-report"></table>
						...
						<div class="modal-dialog modal-dialog-centered  modal-lg">
							...
							<div class="modal-content dep-modal">
								<div class="modal-header">
									...
									<button type="button" class="close" onclick="resetForm('form_public_sc')" data-dismiss="modal">&times;</button>
																...
																<fieldset>
																	<div class="form-card">
																		...
																		<div class="row">
																			<div class="col-sm-12 col-lg-6">
																				<div class="form-group">
																					<label for="shopping_mall_name">Public Distribution System Centers Name<span class="mandatory">*</span></label> <input
																						type="text" class="form-control" id="pdsc_name"
																						name="pds_name" placeholder="Enter Public Distribution System Centers Name">
...
<script type="text/javascript" src="${context}/js/designer/public_dis_s_cen.js"></script>
