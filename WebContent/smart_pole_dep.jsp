...
<title>Smart Pole Department</title>
<!-- Page Content -->
			...
			<div class="tab-content">
				<div class="tab-pane container-fluid active" id="">
					<div class="text-right">
						<button data-toggle="modal" data-target="#addSmartPole_modal" class="btn-add btn-indore-table">Add Smart Pole</button>
					</div>
					<h6 class="table-title-grid">List of Smart Pole</h6>
					<table id="dep_smart_pole_table" class="display tbl_dep" class="tbl-report"></table>
				</div>
			</div>
			<!-- Tab panes end-->
		</div>
