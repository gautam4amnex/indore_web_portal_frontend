...
<title>Religious Facility Department</title>
<!-- Page Content -->
			...
			<div class="tab-content">
				<div class="tab-pane container-fluid active" id="">
					<div class="text-right">
						<button data-toggle="modal" data-target="#addReligiosFacility_modal" class="btn-add btn-indore-table">Add Religious Facility</button>
					</div>
					<h6 class="table-title-grid">List of Religious Facility</h6>
					<table id="dep_religious_facility_table" class="display tbl_dep" class="tbl-report"></table>
				</div>
			</div>
			<!-- Tab panes end-->
		</div>
