...
<div class="modal fade" id="addPharmasies_modal" role="dialog">
	<div class="modal-dialog modal-dialog-centered  modal-lg">
		...
		<div class="modal-content dep-modal">
			<div class="modal-header">
				...
				<h4 class="modal-title">Add Pharmacies</h4>
							...
							<div class="card px-0 pb-0">
								<div class="row">
									...
									<div class="col-md-12 mx-0">
										...
										<form id="form_addPharmacies" class="msform form-admin">
											<!-- progressbar -->
														...
														<div class="col-sm-12 col-lg-6">
															 ...
															 <div class="form-group">
																<label for="loLatitude">Latitude<span
																	...
																	class="form-control" id="pharmacies_latitude"
																	name="latitude"
															...
															<div class="form-group">
																<label for="lowardName">Ward</label> <select
																	class="form-control pb-1" id="pharmacies_ward"
																	name="ward_id">
																</select>
															</div>
														</div>
														...
														<div class="col-sm-12 col-lg-6">
															<div class="form-group">
																<label for="loLongitude">Longitude<span
																	class="mandatory">*</span></label> <input type="text"
																	class="form-control" id="pharmacies_longitude"
																	name="longitude"
											...
											<fieldset>
												<div class="form-card">
													...
													<div class="row">
														<div class="col-sm-12 col-lg-6">
															<div class="form-group">
																<label for="hsName">Pharmacy Name
																	<span class="mandatory">*</span>
																</label>
																<input type="text" class="form-control" id="pharmacies_pharmacy_name"
																	name="pharmacy_name" placeholder="Enter Name" required>
															</div>
															<div class="form-group">
																...
																class="form-control" id="pharmacies_address" 
																placeholder="Enter Address" required></textarea>
															</div>
														</div>
														<div class="col-sm-12 col-lg-6">
															<div class="form-group">
																<label for="hsName">Type of Pharmacies</label> 
																<select
																	class="form-control pb-1" id="pharmacies_type_of_pharmacy"
																	name="type_of_pharmacy">
																	<option value="">Select Type of Pharmacies</option>
											...
											<fieldset>
												<div class="form-card"> 
													...
													<div class="form-group"> 
														...
														id="pharmacies_geoTaggedPhoto" name="geo_tagged_photo" required>
													</div> 
												...
												<input type="submit" id="pharmacy_add_submit" name="pharmacy_add_submit" class="btn btn-indore mt-3" value="Submit" />
											</fieldset>
										</form>
									</div>
								</div>
