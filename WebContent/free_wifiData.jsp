...
<div class="modal fade" id="freeWifi_data_modal" role="dialog">
	<div class="modal-dialog modal-dialog-centered  modal-lg">
		...
		<div class="modal-content dep-modal">
			<div class="modal-header">
				...
				<h4 class="modal-title">Free WI-FI</h4>
							...
							<div class="card px-0 pb-0">
								<div class="row">
									...
									<div class="col-md-12 mx-0">
										...
										<form id="form_freeWifi" name="form_freeWifi"
													...
													<div class="row">
														<div class="col-sm-12 col-lg-6">
															...
															<div class="form-group">
																<label for="freeWifi_latitude">Latitude<span class="mandatory">*</span></label> <input
																	type="text" class="form-control"
																	id="free_wifi_latitude" name="latitude"
																	placeholder="Enter Latitude" required>
															</div>

															<div class="form-group">
																<label for="freeWifi_ward">Ward</label> <select
																	class="form-control pb-1" id="free_wifi_ward"
																	name="ward_id">
																</select>
															</div>
														...
														<div class="col-sm-12 col-lg-6">
															<div class="form-group">
																<label for="form_freeWifi">Longitude<span class="mandatory">*</span></label> <input
																	type="text" class="form-control"
																	id="free_wifi_longitude" name="longitude"
																	placeholder="Enter Longitude" required>
															</div>

															<div class="form-group">
																<input type="hidden" class="form-control"
																	id="free_wifi_subLayerId" name="subLayerId">
															</div>
											...
											<fieldset>
												<div class="form-card">
													...
													<div class="row">
														...
														<div class="col-sm-12 col-lg-6">
															<div class="form-group">
																<label for="wifiarea_name">Area Name<span
																	class="mandatory">*</span></label> <input type="text"
																	class="form-control" id="free_wifi_area_name "
																	name="area_name" placeholder="Enter Area Name" required>
															</div>
															<div class="form-group">
																<label for="wifi_address">Address<span
																	class="mandatory">*</span></label>
																<textarea class="form-control" id="free_wifi_address"
														...
														<div class="col-sm-12 col-lg-6">
															...
															<div class="form-group">
																<label for="wifi_geoTaggedPhoto">Geo Tagged
																	Photo<span class="mandatory">*</span>
																</label> <input type="file" multiple class="form-control"
																	id="free_wifi_geo_tagged_photo"
												...
												<input type="submit" id="add_data_wifi_submit"
													name="add_data_wifi_submit" class="btn btn-indore mt-3"
													value="Submit" />
												<!-- 																	<button type="button" name="next" -->
												<!-- 																		class="next action-button float-right"> -->
												<!-- 																	<i class="fa fa-angle-right" aria-hidden="true"></i> -->
