...
<div class="modal fade" id="addSportsFacility_modal" role="dialog">
	<div class="modal-dialog modal-dialog-centered  modal-lg">
		...
		<div class="modal-content dep-modal">
			<div class="modal-header">
				...
				<h4 class="modal-title">Add Sports Facility</h4>
							...
							<div class="card px-0 pb-0">
								<div class="row">
									...
									<div class="col-md-12 mx-0">
										...
										<form id="form_addSportsFacility" class="msform form-admin">
											<!-- progressbar -->
														...
														<div class="col-sm-12 col-lg-6">
															...
															<div class="form-group">
																<label for="lowardName">Ward</label> <select
																	class="form-control pb-1" id="sports_facility_ward"
																	name="ward_id">
																</select>
															</div>
															 <div class="form-group">
																<label for="loLatitude">Latitude<span
																	...
																	class="form-control" id="sports_facility_latitude"
																	name="latitude"
														...
														<div class="col-sm-12 col-lg-6">
															<div class="form-group">
																<label for="loLongitude">Longitude<span
																	class="mandatory">*</span></label> <input type="text"
																	class="form-control" id="sports_facility_longitude"
																	name="longitude"
												...
												<div class="form-card">
													...
													<div class="row">
														...
														<div class="form-group">
																...
																<input type="text" class="form-control" id="sports_facility_name" 
																name="sports_facility_name" placeholder="Enter Name" required>	
															</div>
														
														
														<div class="form-group">
																<label for="hsName">Type of Sports Facility</label>
																<input type="text" class="form-control" id="sports_facility_type" 
																name="type_of_sports_facility" placeholder="Enter Type of Sports Facility">	
															</div>
															...
															<div class="form-group">
																...
																id="sports_facility_address" placeholder="Enter Address" required></textarea>
															</div>
											...
											<fieldset>
												<div class="form-card"> 
													...
													<div class="form-group"> 
														...
														id="sports_facility_geoTaggedPhoto" name="geo_tagged_photo" required>
													</div> 
												...
												<input type="submit" name="sports_facility_submit" id ="sports_facility_submit" class="btn btn-indore mt-3" value="Submit" />
											</fieldset>
										</form>
									</div>
								</div>
