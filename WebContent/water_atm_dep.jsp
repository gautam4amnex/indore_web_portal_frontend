...
<title>Water ATM Department</title>
<!-- Page Content -->
			...
			<div class="tab-content">
				<div class="tab-pane container-fluid active" id="">
					<div class="text-right">
						<button data-toggle="modal" data-target="#addWaterATM_modal" class="btn-add btn-indore-table">Add Water ATM</button>
					</div>
					<h6 class="table-title-grid">List of Water ATM</h6>
					<table id="dep_water_atm_table" class="display tbl_dep" class="tbl-report"></table>
				</div>
			</div>
			<!-- Tab panes end-->
		</div>
