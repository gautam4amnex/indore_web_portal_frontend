...
<title>Milk Booths Department</title>
<!-- Page Content -->
			...
			<div class="tab-content">
				<div class="tab-pane container-fluid active" id="">
					<div class="text-right">
						<button data-toggle="modal" data-target="#milk_booth_modal" class="btn-add btn-indore-table">Add Milk Booths</button>
					</div>
					<h6 class="table-title-grid">List of Milk Booths</h6>
					<table id="milkBooths_table" class="display tbl_dep" class="tbl-report"></table>
				</div>
			</div>
			<!-- Tab panes end-->
		</div>
