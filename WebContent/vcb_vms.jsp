...
<div class="modal fade" id="addVCBVMS_modal" role="dialog">
	<div class="modal-dialog modal-dialog-centered  modal-lg">
		...
		<div class="modal-content dep-modal">
			<div class="modal-header">
				...
				<h4 class="modal-title">Add VCBs/VMSs</h4>
							...
							<div class="card px-0 pb-0">
								<div class="row">
									...
									<div class="col-md-12 mx-0">
										...
										<form id="form_addVCBVMS" name ="form_addVCBVMS" class="msform form-admin">
											<!-- progressbar -->
													...
													<div class="row">
														<div class="col-sm-12 col-lg-6">
															...
															<div class="form-group">
																<label for="lowardName">Ward</label> <select
																	class="form-control pb-1" id="vcb_vms_ward"
																	name="ward_id">
																</select>
															</div>
															<div class="form-group">
																<label for="loLongitude">Longitude<span
																	...
																	class="form-control" id="vcb_vms_longitude"
																	name="longitude"
														...
														<div class="col-sm-12 col-lg-6">
																...
																<label for="loLatitude">Latitude<span
																	class="mandatory">*</span></label> <input type="text"
																	class="form-control" id="vcb_vms_latitude"
																	name="latitude"
																	placeholder="Enter Latitude" required>
															</div> 
															<div class="form-group">
																<input type="hidden" class="form-control"
																	id="vcb_vms_subLayerId"
																	name="subLayerId">
															</div>
													...
													<div class="row">
														<div class="col-sm-12 col-lg-6">
															<div class="form-group">
																...
																id="vcb_vms_address" placeholder="Enter Address" required></textarea>
															</div>

															<div class="form-group">
																<label for="hsName">Name<span
																	class="mandatory">*</span></label>
																<input type="text" class="form-control" id="vcb_vms_name" 
											...
											<fieldset>
												<div class="form-card"> 
													...
													<div class="form-group"> 
														...
														<input type="file" multiple class="form-control" id="vcb_vms_geoTaggedPhoto" 
												...
												<input type="submit" name="vcbaddsubmit" id ="vcbaddsubmit" class="btn btn-indore mt-3" value="Submit" />
											</fieldset>
										</form>
									</div>
								</div>
