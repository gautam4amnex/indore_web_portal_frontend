			...
			<div class="tab-content">
				<div class="tab-pane container-fluid active" id="">
					<div class="text-right">
						<button data-toggle="modal" data-target="#trafficSquares_modal" class="btn-add btn-indore-table">Add Traffic Square</button>
					</div>
					<h6 class="table-title-grid">List of Traffic Square</h6>
					<table id="traffic_square_table" class="display tbl_dep" class="tbl-report"></table>
				</div>
			</div>
			<!-- Tab panes end-->
		</div>
