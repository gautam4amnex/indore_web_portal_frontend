...
<title>VCB/VMS Department</title>
<!-- Page Content -->
			...
			<div class="tab-content">
				<div class="tab-pane container-fluid active" id="">
					<div class="text-right">
						<button data-toggle="modal" data-target="#addVCBVMS_modal" class="btn-add btn-indore-table">Add VCB/VMS</button>
					</div>
					<h6 class="table-title-grid">List of VCB/VMS</h6>
					<table id="dep_vcb_vms_table" class="display tbl_dep" class="tbl-report"></table>
				</div>
			</div>
			<!-- Tab panes end-->
		</div>
