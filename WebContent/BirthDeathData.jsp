													...
													<div class="row">
														<div class="col-sm-12 col-lg-6">
															<div class="form-group">
																...
																<textarea name="address" rows="" cols="" class="form-control" id="wateratm_address" placeholder="Enter Address"></textarea>
															</div>

															<div class="form-group">
																<label for="hsName">Payment Mode
																	<span class="mandatory">*</span>
																</label>
															...
															<div class="form-group">
																<label for="hsName">Price Per Litter<span
																	class="mandatory">*</span></label> <input type="text"
																	class="form-control"
											...
											<fieldset>
												<div class="form-card"> 
													...
													<div class="form-group"> 
														...
														<input type="file" multiple class="form-control" id="wateratm_geoTaggedPhoto" name="geo_tagged_photo">
													</div> 
