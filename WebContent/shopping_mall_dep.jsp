...
<title>Shopping Mall Department</title>
<!-- Page Content -->
			...
			<div class="tab-content">
				<div class="tab-pane container-fluid active" id="">
					<div class="text-right">
						<button data-toggle="modal" data-target="#shopping_mall_modal" class="btn-add btn-indore-table">Add Shopping Mall</button>
					</div>
					<h6 class="table-title-grid">List of Shopping Mall</h6>
					<table id="dep_shopping_mall_table" class="display tbl_dep" class="tbl-report"></table>
				</div>
			</div>
			<!-- Tab panes end-->
		</div>
