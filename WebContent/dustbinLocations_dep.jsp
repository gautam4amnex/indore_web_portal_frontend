			...
			<div class="tab-content">
				<div class="tab-pane container-fluid active" id="">
					<div class="text-right">
						<button data-toggle="modal" data-target="#dustbin_locations_modal" class="btn-add btn-indore-table">Add Data</button>
					</div>
					<h6 class="table-title-grid">List of Dustbin Locations</h6>
					<table id="dustbin_locations_table" class="display tbl_dep" class="tbl-report"></table>
				</div>
			</div>
			<!-- Tab panes end-->
		</div>
