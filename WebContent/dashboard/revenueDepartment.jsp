...
<!--Revenue & Conference Hall start-->
<div class="revenue-dept awas-single-management side-dashboard-main inactive" id="dashboard_11">
	...
	<div class="row side-dashboard-main-inner">
		...
		<div class="col-12 text-center side-dashboard-title">
			<div class="filter-select-main mt-3 pt-1">	
				<div class="form-group filter-select dashboard-ward-filter">
					<select class="form-control dashboard-ward-filter" name="exportType" data-dashboard_type="24" id="revenueWard">
					</select>
				</div>
			</div>
		</div>
						...
						<div class="row h-100 m-0">
							<div class="col-sm-12 col-md-3 col-lg-2 p-0">
								<div class="row m-0 h-100 justify-content-center align-items-center card-count-custom">
									...
									<p class="title-sub-dept"><span class="count-dept big total_land"></span><br/>Total Land <br/>Area (Sq.)</p>
								</div>
							</div>
							<div class="col-sm-12 col-md-9 col-lg-5 chart-inner">
								<h4>Ownership Type</h4>
								<div class="chart-section h-100" id="ownerType">
							...
							<div class="col-sm-12 col-md-6 col-lg-5 chart-inner">
								<h4>Land System</h4>
								<div class="chart-section h-100" id="landSystem">
								</div>
							</div>
						</div>
					</div>
