		...
		<div class="admin-content">
			...
			<ul class="nav nav-tabs full-linetab-admin justify-content-center">
				<li class="nav-item"><a class="nav-link tab-data active"
					data_translate="_primary" data-toggle="tab" href="#play_ground_Dept">Play ground</a></li>
			</ul>

			<!-- Tab panes -->
			<div class="tab-content">
				<div class="tab-pane container-fluid active" id="play_ground_Dept">

					<div class="text-right">
						<button data-toggle="modal" data-target="#play_ground_modal"
							data_translate="_add_data" class="btn-add btn-indore-table">Add Data</button>
					</div>

					<h6 class="table-title-grid"
						data_translate="_list_of_primary_school">List Of Play Ground</h6>
					<table id="play_ground_table" class="display tbl_dep" class="tbl-report"></table>

					<!-- Play Ground Master Modal start -->
					<div class="modal fade" id="play_ground_modal" role="dialog">
						<div class="modal-dialog modal-dialog-centered  modal-lg">
							...
							<div class="modal-content dep-modal">
								...
								<button type="button" class="close" onclick="resetForm('form_play_ground')" data-dismiss="modal">&times;</button>
																...
																<fieldset>
																	<div class="form-card">
																		...
																		<div class="row">
																			<div class="col-sm-12 col-lg-6">
																				<div class="form-group">
																					<label for="shopping_mall_name">Play Ground Name<span class="mandatory">*</span></label> <input
																						type="text" class="form-control" id="playgr_name"
																						name="play_ground_name" placeholder="Enter Play Ground Name">
																				</div>
																					<div class="form-group">
...
<script type="text/javascript" src="${context}/js/designer/playGround.js"></script>
