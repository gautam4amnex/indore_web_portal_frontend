...
<title>Blood Bank Department</title>
<!-- Page Content -->
			...
			<div class="tab-content">
				<div class="tab-pane container-fluid active" id="">
					<div class="text-right">
						<button data-toggle="modal" data-target="#addBloodBanks_modal" class="btn-add btn-indore-table">Add Blood Bank</button>
					</div>
					<h6 class="table-title-grid">List of Blood Bank</h6>
					<table id="dep_blood_bank_table" class="display tbl_dep" class="tbl-report"></table>
				</div>
			</div>
			<!-- Tab panes end-->
		</div>
