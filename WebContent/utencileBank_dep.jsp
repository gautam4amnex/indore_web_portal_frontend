...
<title>Utencile Bank Locations Department</title>
<!-- Page Content -->
			...
			<div class="tab-content">
				<div class="tab-pane container-fluid active" id="">
					<div class="text-right">
						<button data-toggle="modal" data-target="#utencile_bank_modal" class="btn-add btn-indore-table">Add Data</button>
					</div>
					<h6 class="table-title-grid">List of Utensil Bank Locations</h6>
					<table id="utencile_bank_table" class="display tbl_dep" class="tbl-report"></table>
				</div>
			</div>
			<!-- Tab panes end-->
		</div>
